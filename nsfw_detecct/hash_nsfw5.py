...
class CustomResNet50(nn.Module):
    ...
    def forward(self, x, y=1.0):
        ...
        heshoutput = self.approximate_hash_function(max, y, z)
        #heshoutput = indices*y
        #max_value = torch.max(activations[0][0], activations[1]) 
        return indices, heshoutput, activations, max#, max_value# INT64 -> FLOAT 변환 추가
...
fhe_directory = '/home/giuk/fhe_client_server_files_nsfw_hash_argmax/' # 자기 자신에 맞게 파일명 바꾸기
