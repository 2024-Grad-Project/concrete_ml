...
fhe_directory = '/home/giuk/zama_fhe_directory/test_8_two_input/' # 자기 자신에 맞게 파일명 바꾸기
# Setup the client
client = FHEModelClient(path_dir=fhe_directory, key_dir="/home/giuk/keys_client_cnn_19_Nov_999/")
...
encrypted_data = client.quantize_encrypt_serialize(np_array, constant_input.numpy())
